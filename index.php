    ...
    <header class="sl-nav">
        <div class="sl-nav-inner">
            ...
            <div class="sl-nav-ctas">
                ...
                <button id="slMobileMenuBtn" class="sl-mobile-toggle" aria-label="Menu"><i
    ...
    <section class="sl-hero">
        <div class="sl-hero-inner">
            <div class="sl-hero-text reveal">
                ...
                <p>Save time, reduce costs, and run your hotel smarter than ever with
                    <?php echo htmlspecialchars($appName); ?> — reception, POS, inventory, staff, and reports in one
                    place.</p>
                ...
                <div class="sl-admin-preview" aria-hidden="true">
                    <div class="sl-preview-nav">
                        <div class="sl-preview-brand">
                            <?php if ($publicLogoUrl): ?>
                                <span class="sl-preview-logo"><img src="<?php echo htmlspecialchars($publicLogoUrl); ?>"
                                        alt=""></span>
                            <?php else: ?>
                                <span
                                    class="sl-preview-logo sl-preview-logo-fallback"><?php echo htmlspecialchars(strtoupper(substr($appName, 0, 3))); ?></span>
                            <?php endif; ?>
                            <div>
                        ...
                        <div class="sl-preview-nav-links">
                            <?php foreach ($heroNavLinks as $link): ?>
                                <span
                                    class="sl-preview-nav-link<?php echo $link['active'] ? ' active' : ''; ?>"><?php echo htmlspecialchars($link['name']); ?></span>
                            <?php endforeach; ?>
                        </div>
                            ...
                            <?php foreach ($heroMetrics as $metric): ?>
                                <div class="sl-preview-metric">
                                    <div class="sl-preview-metric-top">
                                        ...
                                        <div class="sl-preview-metric-icon"><i
                                                data-lucide="<?php echo $metric['icon']; ?>"></i></div>
                                    </div>
    ...
    <section id="features" class="sl-feature-row">
        <div class="sl-section-inner sl-feature-split">
            <div class="sl-feature-copy reveal">
                ...
                <p>Handle room bookings, check-ins, checkouts, <strong>stay extensions</strong>, and
                    <strong>re-check-ins</strong> with live room status. Your reception team always knows who is
                    arriving today, who is currently staying, and who is due to depart.</p>
    ...
    <section id="pricing" class="sl-pricing">
        ...
        <div class="sl-section-inner sl-pricing-grid">
            <?php foreach ($pricingPlans as $i => $plan): ?>
                <div
                    class="sl-price-card reveal reveal-d<?php echo ($i % 3) + 1; ?><?php echo $plan['featured'] ? ' sl-price-featured' : ''; ?>">
                    <div class="sl-price-top">
                        <h3><?php echo htmlspecialchars($plan['name']); ?></h3>
                        <div class="sl-price-amount">
                            <span
                                class="sl-price-currency"><?php echo htmlspecialchars($plan['currency'] ?? 'ETB'); ?></span>
                    ...
                    <a href="register.php?plan=<?php echo urlencode($plan['id'] ?? strtolower($plan['name'])); ?>"
                        class="sl-price-btn<?php echo $plan['featured'] ? ' sl-price-btn-fill' : ''; ?>">Choose Plan</a>
                </div>
            <?php endforeach; ?>
        </div>
    </section>
...
<style>
    ...
    .reveal {
        ...
        animation: slUp 0.7s ease forwards;
    }
    ...
    .sl-preview-action-top i {
        width: 14px;
        height: 14px;
        color: var(--green);
    }

    .sl-preview-action-arrow {
    ...
    .sl-feature-split-reverse .sl-feature-copy {
        order: 2;
    }

    .sl-feature-split-reverse .sl-feature-visual {
        order: 1;
    }
    ...
    .sl-integrations {
        padding: 5rem 0;
        background: linear-gradient(135deg, #e8f5ef 0%, #d4ede0 100%);
    }

    .sl-integrations-inner {
        text-align: center;
    }
    ...
    .sl-newsletter-text h3 {
        font-size: 1.5rem;
        font-weight: 900;
        margin: 0 0 0.5rem;
    }

    .sl-newsletter-text p {
        margin: 0;
        opacity: 0.95;
        font-size: 1.0625rem;
        font-weight: 500;
    ...
    .sl-newsletter-form .sl-btn-green {
        background: #fff;
        color: var(--green);
        box-shadow: none;
    }

    .sl-newsletter-form .sl-btn-green:hover {
        background: var(--green-soft);
    }
    ...
    @media (max-width: 767px) {
        ...
        .sl-desktop-nav,
        .sl-nav-ctas .sl-btn-outline,
        .sl-nav-ctas .sl-btn-green {
            display: none;
        }
